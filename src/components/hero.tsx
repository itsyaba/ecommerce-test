...
export default function HeroSection() {
  return (
    <section className="bg-background">
      <div className="mx-auto grid w-full max-w-6xl grid-cols-2 my-8 xl:max-w-7xl min-h-[80vh]">
        ...
        <div className="relative flex w-full flex-1 items-center justify-center h-full ">
